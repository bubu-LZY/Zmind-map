...
export const shortcutKeyList = [
  ...
  },
  {
    type: '文字颜色',
    list: [
      { icon: '', name: '默认', value: 'Alt + D' },
      { icon: '', name: '红色', value: 'Alt + R' },
      { icon: '', name: '黄色', value: 'Alt + Y' },
      { icon: '', name: '绿色', value: 'Alt + G' },
      { icon: '', name: '蓝色', value: 'Alt + B' },
      { icon: '', name: '紫色', value: 'Alt + P' }
    ]
  },
  {
    type: '高亮',
    list: [
      { icon: '', name: '黄色', value: `${ctrl} + Alt + Y` },
      { icon: '', name: '红色', value: `${ctrl} + Alt + R` },
      { icon: '', name: '灰色', value: `${ctrl} + Alt + H` },
      { icon: '', name: '绿色', value: `${ctrl} + Alt + G` },
      { icon: '', name: '蓝色', value: `${ctrl} + Alt + B` },
      { icon: '', name: '粉色', value: `${ctrl} + Alt + P` },
      { icon: '', name: '青色', value: `${ctrl} + Alt + C` }
    ]
  },
  {
    type: '导航',
