...
export default {
  ...
  created() {
    ...
    // 对齐幕布：Ctrl+Shift+F 全局搜索（与文档内搜索共用同一搜索面板）
    this.mindMap.keyCommand.addShortcut('Control+Shift+f', this.showSearch)
  ...
  beforeDestroy() {
    ...
    this.mindMap.keyCommand.removeShortcut('Control+Shift+f', this.showSearch)
