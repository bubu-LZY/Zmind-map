export default {
  ...
  import: {
    ...
    mdEmptyTip: '内容不能为空',
    pasteMarkdown: '粘贴Markdown文本',
    pasteMarkdownTitle: '粘贴 Markdown 文本',
    pasteMarkdownTip: '支持标题（#）和无序/有序列表（-、1.）语法，可多层嵌套',
    pasteMarkdownEmpty: '请先粘贴 Markdown 内容'
  },
  navigatorToolbar: {
    openMiniMap: '开启小地图',
    closeMiniMap: '关闭小地图',
  ...
  ai: {
    ...
    VolcanoArkLargeModelConfiguration: 'OpenAI 兼容接口配置：',
    configTip:
      '支持所有符合 OpenAI 规范的接口（OpenAI、DeepSeek、通义千问、Kimi、火山方舟、Ollama 等），填写接口地址、API Key 和模型即可。',
    apiAddress: '接口地址',
    modelPlaceholder: '如 gpt-4o-mini、deepseek-chat，火山方舟填接入点 ID',
    configExamples:
    ...
    apiValidateTip: '请输入接口地址',
    keyValidateTip: '请输入API Key',
    modelValidateTip: '请输入模型名称',
    ...
    aiCreatePartMsgHelp:
      '。需要以Markdown格式返回，并且只能使用Markdown的标题和无序列表两种语法，可以支持多层嵌套。只需返回内容即可。',
    aiCreatePart: 'AI续写',
    aiCreatePartReferenceKnowledge: '参考知识续写',
    aiCreatePartMinimalist: '极简续写',
    aiCreatePartReferenceKnowledgePlaceholder: '请输入参考知识，AI将根据这些知识进行续写...',
    aiCreatePartReferenceKnowledgeMsg: '。请严格根据以下参考知识进行续写，严禁天马行空、自由发散，所有续写内容必须基于参考知识，不得添加参考知识以外的内容：\n',
    aiCreatePartMinimalistMsg: '。请注意不要太过于发散，续写不要超过两个层级的节点，优先只续写一个层级，实在内容太多了，再续写两个层级。'
  },
  note: {
    title: '备注'
  },
