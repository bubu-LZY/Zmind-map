export default {
  ...
  ai: {
    ...
    aiCreatePartReferenceKnowledge: 'Reference Knowledge',
    aiCreatePartMinimalist: 'Minimalist',
    aiCreatePartReferenceKnowledgePlaceholder: 'Enter reference knowledge, AI will use it for continuation...',
    aiCreatePartReferenceKnowledgeMsg: '. Please strictly continue writing based on the following reference knowledge. Do not add any content beyond the reference knowledge. All continuation must be derived from the reference knowledge:\n',
    aiCreatePartMinimalistMsg: '. Please do not be too divergent. The continuation should not exceed two levels of nodes. Prioritize only one level. Only use two levels if there is too much content.'
  },
  note: {
    title: 'Note'
  },
